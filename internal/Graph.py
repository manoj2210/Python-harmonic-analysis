...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Head_label.setText(_translate("MainWindow",
                                           "<html><head/><body><p align=\"center\"><span style=\" font-size:28pt; color:#ffffff;\">Fourier Series Equation</span></p></body></html>"))
        self.Equation_label.setText(
            _translate("MainWindow", "<html><head/><body><p align=\"center\">" + self.Eq + "</p></body></html>"))
        self.Head_label1.setText(_translate("MainWindow",
                                            "<html><head/><body><p align=\"center\"><span style=\" font-size:22pt;\">Graph</span></p></body></html>"))
        self.Head_label2.setText(_translate("MainWindow",
                                            "<html><head/><body><p align=\"center\">Fourier Series for Given Harmonic</p></body></html>"))
        self.Draw_graph_button.setText(_translate("MainWindow", "Draw Graph"))
        self.Head_label3.setText(_translate("MainWindow",
                                            "<html><head/><body><p align=\"center\">Visualisation of Harmonic Analysis</p></body></html>"))
