...
label1.setStyleSheet("background-color:black;\n"
                                    ...
                                    "color:white;")
label1.setGeometry(1600,850,300,250)
label1.setWindowFlags(QtCore.Qt.FramelessWindowHint)
...
Ok_button.setGeometry(100,900,120,100)
